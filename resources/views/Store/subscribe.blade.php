    ...
    <section class="checkout spad">
        <div class="container">
            <div class="checkout__form">
                <form action="{{ route('home.save-meal-plan') }}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <div class="checkout__order__products">Meal Plan Details
                                    </div>
                                    <div class="form-group row">
                                        <select name="product_id" id="product" class="form-control col-12">
                                            <option>Select Meal weekly Plan</option>
